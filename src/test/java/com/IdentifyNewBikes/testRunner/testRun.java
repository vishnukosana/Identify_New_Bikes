...
@CucumberOptions(features= {"src//test//resources//featureFile//AcronymApp.feature"},		// Specifying the location of the feature file(s) that contain Gherkin syntax
				 glue= {"com.acronymsAppValidation.stepDefinitions"},		// Specifying the package containing step definitions
